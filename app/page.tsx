  ...
  return (
    <div className="flex flex-col">
              ...
              <div className="text-white max-w-2xl">
                ...
                <div className="flex gap-4">
                  <Link href={slide.ctaUrl}>
                    <button className="bg-primary hover:bg-primary/90 text-white px-8 py-3 text-lg font-medium transition-colors">
                      {slide.ctaText}
                    </button>
                  </Link>
                  <button
                    onClick={() => openVideoModal(slide.videoUrl)}
                    className="bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white px-8 py-3 text-lg font-medium transition-colors flex items-center gap-2"
                  >
            ...
            >
              ...
              >
                {newsArticles.map((article, idx) => (
                  ...
                  >
                    <Card className="overflow-hidden hover:shadow-lg transition-shadow bg-white py-0 pb-6 rounded-none h-full">
      ...
      <div className="flex flex-col md:flex-row max-w-7xl mx-auto gap-4 px-6">
        {/* Knowledge Section */}
        <section
          className="relative h-auto bg-cover bg-center w-100 md:w-[50%] shadow-sm hover:shadow-lg transition-shadow border"
          style={{
            backgroundImage:
        ...
        {/* Donate Section */}
        <section
          className="relative py-10 bg-cover bg-center w-100 md:w-[50%] shadow-sm hover:shadow-lg transition-shadow border"
          style={{
            backgroundImage:
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                image:
                  "https://images.unsplash.com/photo-1631815588090-d4bfec5b1ccb?q=80&w=2086",
                category: "Blog",
              ...
              {
                image:
                  "https://images.unsplash.com/photo-1604357209793-fca5dca89f97?q=80&w=2128",
                category: "Blog",
