...
import { Lightbulb, Settings, Home, Trees } from "lucide-react";
    ...
    <div className="flex flex-col">
      ...
      >
        ...
        <div className="relative h-full max-w-7xl mx-auto px-6 flex flex-col justify-center">
          <p className="text-white text-lg mb-4">About Us</p>
          <h1 className="text-white text-4xl md:text-5xl lg:text-6xl font-bold max-w-3xl leading-tight">
            Health is your fundamental right
          </h1>
          <p className="text-white text-lg md:text-xl mt-6 max-w-3xl leading-relaxed">
            We are a coalition of doctors, nutritionists, patients, and families
            who believe every Pakistani deserves the knowledge and tools to live a
            life free from the grip of diabesity. This is our promise to you and
            to Pakistan.
          </p>
        </div>
      </section>
